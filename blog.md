...
![Kaplan-Meier 生存曲线](assets/images/p1.png)
...
![单变量生存曲线](assets/images/p2.png)
![生存概率提取](assets/images/p3.png)
...
![Cox 比例风险模型](assets/images/p4.png)
![Cox 模型结果](assets/images/p5.png)
![风险比图](assets/images/p6.png)
## Step 3.2: 检验比例风险假设
为了验证 Cox 比例风险模型中的比例风险假设是否成立，我们绘制了 **log-log 图**，通过该图可以判断变量是否符合比例风险假设。如果比例风险假设被违反，模型的推断可能不准确，因此这一检验至关重要。

![log-log图](assets/images/p7.png)
...
![可交互界面1](assets/images/p9.png)
![可交互界面2](assets/images/p10.png)
